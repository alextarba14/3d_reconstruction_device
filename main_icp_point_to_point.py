...
from test_icp_point_to_point import equalize_dimensions
...
# equalize dimensions for icp point-to-point
equalize_dimensions(vertices_array, colors_list)
...
export_numpy_array_to_ply(main_pc[indices], main_color[indices], "./facultate/down_sampled_result.ply",
